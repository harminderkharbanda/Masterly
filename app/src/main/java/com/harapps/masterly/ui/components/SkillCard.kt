...
fun SkillCartItem(skill: Skill,
    ...
    Card(
        ...
        border = BorderStroke(width = 1.dp, color = textSecondary),
        ...
        Column(modifier = Modifier
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(text = stringResource(R.string.x_by_10k_hrs, skill.hoursCompleted),
            ...
            Row(
                ...
                Text(text = stringResource(R.string.skill_percentage, skill.percentageCompleted),
                    color = textPrimary,
            ...
            RoundedProgressBar(skill.percentageFraction)
        }
    }
}
...
fun SkillCardPreview() {
    MasterlyTheme {
        SkillCartItem(Skill("Guitar", 0.25f, 12,"1,250"), onClick = {  })
    }
}
